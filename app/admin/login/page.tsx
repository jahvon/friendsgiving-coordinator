...
import { Shield, Loader2, Utensils } from 'lucide-react';
      ...
      <div className="max-w-md w-full">
        <div className="bg-white shadow-2xl rounded-2xl p-8">
          <div className="text-center mb-8">
            <Shield className="w-16 h-16 mx-auto mb-4 text-terra-600" />
            <h1 className="font-display text-3xl font-semibold text-terra-900 mb-2">
              Admin Login
            </h1>
            <p className="text-terra-700">
              Enter admin password to manage the event
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <Shield className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-terra-600" />
                <input
                  type="password"
                  id="password"
                  required
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-gradient-to-r from-terra-500 to-terra-600 text-white py-4 px-6 rounded-full hover:from-terra-600 hover:to-terra-700 disabled:from-gray-400 disabled:to-gray-400 disabled:cursor-not-allowed font-semibold text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all flex items-center justify-center gap-2"
            >
              {loading ? (
                <>
